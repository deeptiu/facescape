...
output_dir = "filtered_neutral_frames/"

all_subjects = get_all_unique_subjects(base_path)
all_subjects = all_subjects[32:]
...
for subject_name in all_subjects:
    ...
    video_paths, frame_ids = find_neutral_frame(subject_name, base_path, all_frames, all_video_paths)

    tup, paths = extract_from_video(video_paths, output_dir, frame_ids, subject_name)
    ...
    for src_path in paths:
        ...
        if check_eyes_open(kp2d) and check_gaze_forward(kp2d, src_path):
